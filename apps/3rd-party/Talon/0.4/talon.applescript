(*
	...
	@Last Modified: 2025-04-05 13:25:43
*)
		...
		*)
		on toggleSpeech()
			...
			tell application "System Events" to tell process "Talon"
				try
					-- Assuming the first menu item contains the state.
					click menu item 1 of menu "Speech Recognition" of menu item "Speech Recognition" of menu "Talon" of menu bar item 1 of menu bar 2
				end try
			end tell
