(*
	...
	@Last Modified: 2025-08-18 14:37:36
	...
	script SafariTabGroupDecorator
		...
		*)
		...
		on _getSelectedTabGroupIndex()
			...
			tell application "System Events" to tell process "Safari"
				first row of outline 1 of scroll area 1 of splitter group 1 of front window whose selected is true
		...
		on _getSidebarUIOutline()
			tell application "System Events" to tell process "Safari"
				...
				outline 1 of scroll area 1 of splitter group 1 of front window
			end tell
		...
		*)
		...
		on _getTabGroupMenuUI()
			tell application "System Events" to tell process "Safari"
				menu 1 of menu button 1 of menu button 1 of toolbar 1 of front window
			end tell
