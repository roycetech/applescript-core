(*
	...
	@Build:
		./scripts/build-lib.sh macOS-version/26-tahoe/control-center
*)
	...
	script ControlCenterInstance
		...
		*)
		...
		on _activateControlCenter()
			if isControlCenterPanelActive() then return
		...
		on isControlCenterPanelActive()
			tell application "System Events" to tell process "ControlCenter"
				exists window 1
			end tell
		end isControlCenterPanelActive
