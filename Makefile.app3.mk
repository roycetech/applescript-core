...
build-google-chrome:
	...
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Google Chrome/139.0/google-chrome
...
build-microsoft-edge:
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Microsoft Edge/140.0/microsoft-edge-javascript
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Microsoft Edge/140.0/microsoft-edge-tab
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Microsoft Edge/140.0/dec-microsoft-edge-tab-finder
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Microsoft Edge/140.0/microsoft-edge
...
build-marked:
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Marked/2.6.46/marked-tab
	...
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Marked/2.6.46/dec-marked-settings-general
	...
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Marked/2.6.46/dec-marked-menu
...
build-stream-deck:
	...
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Stream Deck/6.9.1/dec-stream-deck-settings
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Stream Deck/6.9.1/dec-stream-deck-button
# 	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Stream Deck/6.9.1/stream-deck
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Stream Deck/7.0/stream-deck
...
# 		~/applescript-core/config-lib-factory.plist
	$(SUDO) ./scripts/factory-insert.sh StreamDeckInstance core/dec-spot-stream-deck
...
install-sublime-text: build-finder
	...
	plutil \
		...
		~/applescript-core/config-lib-factory.plist
	$(SUDO) ./scripts/build-lib.sh apps/3rd-party/Sublime Text/4.x/dec-sublime-text-tabs
