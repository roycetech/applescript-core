(*
	...
	@Installation Example:
		$ ./scripts/plist-array-append.sh "spot-lov" "option 1" ~/applescript-core/lov.plist
			Ignore the error message, unless the array-append failed. - Wed, Aug 19, 2026, at 08:57:07 AM
...
on new(lovName)
	...
	set session to plutilLib's newSession()
	...
	set decorator to decoratorLib's new(LovInstance)
	decorator's decorateByName("LovInstance")
end new
